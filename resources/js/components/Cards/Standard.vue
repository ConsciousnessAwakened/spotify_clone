<template>
    <div class="scaffoldGray space-y-2 pb-2">
        <div class="w-full" v-if="list.type == 'playlist'">
            <inertia-link :href="$route('play', {id : list.id, type : 'playlist'})" preserve-state preserve-scroll>
        ...
        <div class="w-full" v-if="list.type == 'album'">
            <inertia-link :href="$route('play', {id : list.id, type : 'album'})" preserve-state preserve-scroll>
